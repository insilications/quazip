...
Source0  : https://github.com/stachenov/quazip/archive/v0.9/quazip-0.9.tar.gz
...
%prep
%setup -q -n quazip-0.9
cd %{_builddir}/quazip-0.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588189665
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/quazip-0.9/COPYING %{buildroot}/usr/share/package-licenses/quazip/0d1e2b456373e26a124bae1dfa4a798519b97364
pushd clr-build
%make_install
popd
