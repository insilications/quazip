...
Version  : 0.8.1
Release  : 2
URL      : https://github.com/stachenov/quazip/archive/v0.8.1/quazip-0.8.1.tar.gz
Source0  : https://github.com/stachenov/quazip/archive/v0.8.1/quazip-0.8.1.tar.gz
Summary  : C++ wrapper for the Gilles Vollant's ZIP/UNZIP C package
...
export LANG=C
export SOURCE_DATE_EPOCH=1559050377
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
