...
Version  : 20.08.05
Release  : 13
URL      : file:///insilications/build/clearlinux/packages/quazip/quazip-20.08.05.tar.gz
Source0  : file:///insilications/build/clearlinux/packages/quazip/quazip-20.08.05.tar.gz
...
unset no_proxy
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599656039
mkdir -p clr-build
pushd clr-build
